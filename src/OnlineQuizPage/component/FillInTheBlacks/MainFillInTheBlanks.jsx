  ...
  question_data: [
    {
      ...
      upload_file_name: "https://s3.ap-south-1.amazonaws.com/begalileo-assets/BaseTenBlocks/Green-Hundred.png",
      level: "level3",
      fib_text: "",
      fib_before_text:
...
export default function MainFillInTheBlanks({obj,meter,choiceId}){
    return <FillInTheBlanks state={obj?.question_data[0]} meter={meter} choiceId={choiceId}/>
}