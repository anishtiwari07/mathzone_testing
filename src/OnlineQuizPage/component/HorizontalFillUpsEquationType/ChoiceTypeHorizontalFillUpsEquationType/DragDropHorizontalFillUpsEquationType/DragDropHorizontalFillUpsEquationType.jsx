    ...
    <>
          ...
          {items?.map((item, i) =>
            item.isMissed !== "true" ? (
              ...
              <div
                ...
                style={
                  {
                    border:`${(item.show||isStudentAnswerResponse)?0:1}px dashed black`,minHeight:'90px'
                  }
                }
              >
      ...
      <div className={styles.HorizontalPictureDragDropFlexBox2}>
        {dragState?.map((items, i) => (
          <div id={`${i}`} className={`draggablehfu ${styles.HorizontalPictureDragDropBox}`} style={{border:`${items?.show?0:1}px solid black`,minHeight:'90px'}}>
            {items.show && (
